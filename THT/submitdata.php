...
if(isset($_POST['submit'])){
    ...
    if(empty($data_missing)){
        ...
        $query = "INSERT INTO `tenant`(`firstName`, `lastName`, `occupation`, `hometown`, `pic`, `fatherName`, `mobNo`, `permAdd`, `city`, `state`, `country`, `adhar`, `gender`, `birthdate`, `nationality`, `unique_ID`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        mysqli_stmt_bind_param($stmt, "ssssssissssissss", $firstName,
                               $lastName, $occupation, $hometown, $pic,
                               $fatherName, $mobNo, $permAdd, $city,
                               $state, $country, $adhar, $gender, $birthdate, $nationality, $unique_ID);
