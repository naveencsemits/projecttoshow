...
<!-- use this<?php  echo  $row['fname'];  ?> -->
                    ...
                    <tr>
                        ...
                        <td>
                        <textarea rows="4" cols="50" name="criminal_records"></textarea>
                      ...
                      <tr>
                        <td>RE-ENTER TENANT UNIQUE ID:</td>
                        <td>

                          <input type="text" name="reenteredID" ><br>
...
if(isset($_POST['submit'])) {
  $connection = mysqli_connect("localhost", "root", "", "complete_minor");
  $reenteredID = $_POST['reenteredID'];
  $CR = $_POST['criminal_records'];

  $sqlquery ="UPDATE `tenant` SET criminal_records = '$CR' WHERE unique_ID = '$reenteredID'";
